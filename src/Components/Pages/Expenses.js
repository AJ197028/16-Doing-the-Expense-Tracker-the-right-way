...
const Expenses = () => {
    ...
    const handleDelete = async (expense) => {
        ...
        try {
            let responce = await fetch(
                `https://expensetracker-dd10a-default-rtdb.firebaseio.com/expenses/${expense.Name}.json`,
                {
                    method: 'DELETE',
                    headers: {
    ...
    const handleEdit = async (expense) => {
        ...
        try {
            let responce = await fetch(
                `https://expensetracker-dd10a-default-rtdb.firebaseio.com/${expense.Name}.json`,
                {
                    method: 'PUT',
